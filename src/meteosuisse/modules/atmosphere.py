...
class AtmosphereMeasurements:
    ...
    def list_radio_soundings_items(self, *, start_iso: str, end_iso: str, collection_id: str) -> list[dict]:
        ...
        try:
            ...
            return stac.search_items(collection_id=collection_id, datetime_range=dt_range, limit=200)
        finally:
            stac.close()
