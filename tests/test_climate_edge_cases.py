...
def test_climate_get_homogeneous_series_empty_dataframe(mock_read_csv, mock_httpx_client, mock_stac_class):
...
@patch("meteosuisse.modules.climate.httpx.Client")
@patch("meteosuisse.modules.climate.pd.read_csv")
def test_climate_get_homogeneous_series_timezone_handling(mock_read_csv, mock_httpx_client, mock_stac_class):
