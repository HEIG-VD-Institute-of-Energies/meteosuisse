...
def test_ground_based_get_automatic_weather_stations_frequency_now_historical(
...
@patch("meteosuisse.modules.ground_based.httpx.Client")
@patch("meteosuisse.modules.ground_based.pd.read_csv")
def test_ground_based_get_automatic_weather_stations_frequency_now_recent(
    mock_read_csv, mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.httpx.Client")
@patch("meteosuisse.modules.ground_based.pd.read_csv")
def test_ground_based_get_automatic_weather_stations_frequency_historical(
    mock_read_csv, mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.STACClient")
@patch("meteosuisse.modules.ground_based.httpx.Client")
def test_ground_based_get_automatic_weather_stations_non_csv_asset(
    mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.httpx.Client")
@patch("meteosuisse.modules.ground_based.pd.read_csv")
def test_ground_based_get_automatic_weather_stations_fallback_asset_selection(
    mock_read_csv, mock_httpx_client, mock_stac_class, monkeypatch
):
    ...
    """
    from meteosuisse.modules.ground_based import (
    ...
    def wrapper_method(
        self, *, station_id=None, granularity=None, frequency=None, start=None, end=None
    ):
...
def test_ground_based_get_automatic_weather_stations_date_parsing_exception(
    mock_to_datetime, mock_read_csv, mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.pd.read_csv")
@patch("meteosuisse.modules.ground_based.pd.to_datetime")
def test_ground_based_get_automatic_weather_stations_empty_after_parsing(
    mock_to_datetime, mock_read_csv, mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.httpx.Client")
@patch("meteosuisse.modules.ground_based.pd.read_csv")
def test_ground_based_get_automatic_weather_stations_tz_localize(
    mock_read_csv, mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.pd.read_csv")
@patch("meteosuisse.modules.ground_based.pd.to_datetime")
def test_ground_based_get_automatic_weather_stations_tz_convert(
    mock_to_datetime, mock_read_csv, mock_httpx_client, mock_stac_class
):
...
@patch("meteosuisse.modules.ground_based.httpx.Client")
@patch("meteosuisse.modules.ground_based.pd.read_csv")
def test_ground_based_get_automatic_weather_stations_broad_text_search(
    mock_read_csv, mock_httpx_client, mock_stac_class
):
